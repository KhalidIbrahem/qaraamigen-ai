      ...
      <section className="relative z-10 container mx-auto px-4 py-16 pt-24 min-h-[80vh]">
        ...
        >
          <p className="leading-relaxed">
            Hello! I&apos;m{" "}
            <strong className="text-neon-cyan">Khalid Ibrahim</strong>, a{" "}
            <span className="text-blue-400 font-bold">
              software developer, AI researcher
            </span>
            , and passionate <strong>oud</strong> player dedicated to preserving
            Somali cultural music through modern technology.
          </p>
          <p className="leading-relaxed">
            I studied Computer Science and Electrical & Electronic Engineering
            in Turkey, where I deepened my understanding of programming,
            mathematics, and acoustics. Alongside my academic journey, I trained
            in traditional oud performance and studied both Western 7-note
            scales and Somali 5-note scales.
          </p>
          <p className="leading-relaxed italic">
            Music has always been more than a passion; it is a responsibility. I
            grew up surrounded by the soulful rhythms of Somali Qaraami songs,
            and realized that unlike other global musical traditions, Somali
            music has very limited written documentation or academic digital
            archiving. This realization shaped a long-term mission that defines
            who I am today.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-32"
        >
          <h2 className="text-4xl font-black text-center mb-16 text-white tracking-tight">
            Innovation & Research
          </h2>
            ...
            {innovationCards.map((card, index) => (
              ...
              >
                ...
                <div className="relative z-10 text-center p-8">
                  <div
                    className={`w-20 h-20 mx-auto mb-6 rounded-2xl flex items-center justify-center bg-white/10 backdrop-blur-md border border-white/20 text-4xl text-${card.color}-400 group-hover:scale-110 group-hover:text-white transition duration-500`}
                  >
                    {card.icon}
                  </div>
                  ...
                  <p className="text-gray-400 text-sm mb-8 font-light italic leading-relaxed">
                    {card.desc}
                  </p>
                ...
                <div
                  className={`absolute inset-0 border-2 border-transparent group-hover:border-${card.color}-500/30 rounded-[2rem] transition duration-500`}
                />
              </motion.a>
            ))}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div
                key={i}
                className="p-6 bg-white/5 rounded-2xl border border-white/5 hover:border-white/20 transition-all group"
              >
                <div
                  className={`${skill.color} text-4xl mb-4 mx-auto group-hover:scale-110 transition-transform`}
                >
                  {skill.icon}
                </div>
        ...
        >
          ...
          <p className="text-xl text-gray-400 text-center mb-16 max-w-3xl mx-auto font-light leading-relaxed italic">
            &quot;The Oud is the backbone of traditional Somali melodies,
            keeping me intimately connected to my heritage.&quot;
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <Image
                src="/images/khalid-with-oud.jpg"
                alt="Khalid playing Oud"
                fill
            ...
            >
              <Image
                src="/images/khalid-with-teacher.jpg"
                alt="Learning Oud"
                fill
                className="object-cover group-hover:scale-110 transition-transform duration-1000"
              />
        ...
        >
          ...
          <p className="text-lg text-gray-300 leading-[2.2] font-light">
            I am particularly eager to deepen my research into{" "}
            <strong className="text-neon-cyan">
              generative AI for non-Western music
            </strong>
            . My vision is to become a leader in developing innovative tools
            that empower musicians and preserve diverse musical traditions
            through the lens of machine learning and human-computer interaction.
          </p>
        </motion.div>
      </section>
    </div>
