...
export default function TechnicalPage() {
  ...
  const mediaVariants = {
    ...
    visible: {
      opacity: 1,
      scale: 1,
      transition: { duration: 0.8, ease: "easeOut", delay: 0.3 as const },
    },
  };
      ...
      <section className="relative z-10 container mx-auto px-4 pt-32 pb-16 min-h-[80vh]">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light italic">
            Combining algorithmic rigor with musical performance to preserve the
            Somali tradition.
          </p>
        </motion.div>
        ...
        >
          <p className="leading-relaxed">
            This page details the technical coding challenge for my application.
            The task was to demonstrate proficiency in{" "}
            <strong className="text-neon-cyan">
              algorithmic problem-solving and DSP concepts
            </strong>{" "}
            without using external audio libraries.
          </p>
          <p className="leading-relaxed font-light italic">
            My solution uses Python (NumPy) to synthesize a &quot;Qaraami
            melody&quot;—a stylistic homage to traditional Somali music. This
            merges my engineering expertise with my cultural heritage.
          </p>
        ...
        >
          ...
          <p className="text-gray-400 mb-10 font-mono text-sm">
            Writing robust Python code to manage digital audio synthesis, custom
            envelopes, and musical structures.
          </p>
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent flex items-end p-8">
              <p className="text-white text-xl font-bold flex items-center gap-3 italic">
                <FaFileCode className="text-neon-cyan" /> Python Script for
                Audio Generation
              </p>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="grid gap-4">
            {[
              {
                file: "/audio/somali_melody.wav",
                label: "Basic Melody Generation",
              },
              {
                file: "/audio/somali_fm_swing.wav",
                label: "FM Synthesis with Swing",
              },
              {
                file: "/audio/somali_studio_mix.wav",
                label: "Full Studio Mix (Python)",
              },
              {
                file: "/audio/somali_masterpiece.mp3",
                label: "Real Oud String Extraction",
              },
            ].map((track, i) => (
              <div
                key={i}
                className="flex flex-col md:flex-row items-center justify-between p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-neon-cyan/30 transition-all group"
              >
                ...
                <audio
                  controls
                  className="w-full md:w-1/2 h-10 opacity-70 hover:opacity-100 transition-opacity"
                  src={track.file}
                />
              </div>
            ))}
        ...
        >
          <div className="text-center mb-16">
            ...
            <div className="max-w-3xl mx-auto p-8 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 italic text-gray-400 leading-relaxed text-sm">
              This performance demonstrates my current musical ability. It
              represents my ongoing effort to preserve the Somali Qaraami
              repertoire through structured musical interpretation.
        ...
        <div className="max-w-6xl mx-auto mb-32 pt-20 border-t border-white/10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto font-light italic">
              To demonstrate my grasp of Digital Signal Processing, I built this
              synthesis engine using{" "}
...
play_note(freq, time)`}
        ...
        >
          <p className="text-2xl font-light italic text-gray-400 leading-relaxed">
            &quot;This challenge solidified my commitment to exploring how
            computational methods can not only innovate in music creation but
            also profoundly connect with and enrich cultural expressions.&quot;
          </p>
        </motion.div>
      </section>
    </div>
